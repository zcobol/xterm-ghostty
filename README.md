Terminfo for `ghostty` terminal emulator. Copy file to `/usr/share/terminfo/x/xterm-ghostty` and create link `/usr/share/terminfo/g/ghostty` pointing to it.

Verify with `infocmp`. The output should look like this:
